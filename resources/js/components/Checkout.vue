            ...
            <div class="row">
                            ...
                            <div class="panel panel-info">
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12"><input type="text" v-model="phoneNumber"name="phone_number" class="form-control" value="" /></div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-12"><strong>Email Address:</strong></div>
                                        <div class="col-md-12">
                                            <input type="text"  v-model="email" name="email_address" class="form-control" value="" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12"><input type="text" v-model="cardCvv" class="form-control" name="car_code" value="" /></div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control" v-model="expirationMonth" name="">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control" v-model="expirationYear" name="">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <button type="submit"
                                                    ...
                                                    class="btn btn-primary btn-submit-fix">Place Order</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-5 col-xs-12">
                    ...
                    <div class="widget" >
                        ...
                        <div class="summary-block"   v-for="summeryItem in items" :key="summeryItem.id">
                            <div class="summary-content" v-if="summeryItem.name">
                                <div class="summary-head"><h5 class="summary-title">{{summeryItem.name}}</h5></div>
                                <div class="summary-price">
                                    ...
                                    <span class="summary-small-text pull-right">
                                        Q: {{summeryItem.quantity}} x
                                        P: {{summeryItem.sale_price}}
                                    </span>
                                </div>
                            </div>
                        </div>
                        <div class="summary-block">
                            <div class="summary-content">
                                <div class="summary-head"> <h5 class="summary-title">Total
                                </h5></div>
                                <div class="summary-price">
                                    <p class="summary-text">{{items.totalAmount}}
                                        </p>
    ...
    methods:{
      async getCartItems(){
        ...
        async getUserAddress(){
          if (this.firstName != '' && this.address != '' && this.cardNumber && this.cardCvv){
